...
class PengajuanFinanceController extends ResourceController
{
    ...
    public function index()
    {
        ...
        $data = $this->model->getPaginatedData($limit, $page, ['status_on_manager' => 'Approved', 'status_on_finance' => 'Pending']);
    ...
    {
        $data = $this->model->where(['status_on_manager' => 'Approved', 'status_on_finance' => 'Pending'])->find($id);
        return $this->respond([
            'success' => true,
